...
timeline
    ...
    In Development : Extended usability with reading the modelfile and specializing the AI. Furthermore scanning the local repo for creating a markdown with all of the code documented.
